...
:breads="[
    ...
    ['url' => route('invoices.index') , 'title' => translate('فواتير المبيعات') , 'isactive' => false],
    ['url' => route('invoices.show', $invoice->id) , 'title' =>  translate(' فاتورة مبيعات رقم  ') . $invoice->id , 'isactive' => false],
