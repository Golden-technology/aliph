            ...
            @permission('categories-read')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('categories.index') }}">
                        ...
                        <span class="side-menu__label">{{ translate('الاقسام') }}</span></a>
                </li>
            @endpermission
            ...
            @permission('stores-read')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('stores.index') }}">
                        ...
                        <span class="side-menu__label">{{ translate('المخازن') }}</span></a>
                </li>
            @endpermission
            ...
            @permission('units-read')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('units.index') }}">
                        ...
                        <span class="side-menu__label">{{ translate('الوحدات') }}</span></a>
                </li>
            @endpermission

            @permission('taxes-read')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('taxes.index') }}">
                        <svg 
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                        ...
                        <span class="side-menu__label">{{ translate('الضرائب') }}</span></a>
                </li>
            @endpermission
            ...
            @permission('items-read')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('items.index') }}">
                        ...
                        <span class="side-menu__label">{{ translate('المنتجات') }}</span></a>
                </li>
            @endpermission
        </ul>
    </div>
