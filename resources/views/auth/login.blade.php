...
@section('title')
{{ translate('تسجيل دخول') }}
@stop

    @section('css')
    <link
        href="{{ asset('assets/plugins/sidemenu-responsive-tabs/css/sidemenu-responsive-tabs.css') }}"
        rel="stylesheet">
    @endsection
                                ...
                                <div class="card-sigin">
                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            <h2>{{ translate('مرحبا بك') }}</h2>
                                            <h5 class="font-weight-semibold mb-4"> {{ translate('تسجيل الدخول') }} </h5>
