...
class VendorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return url()->previous() == url('/') . '/vendors/create' ?  redirect()->route('vendors.show', $vendor->id)->with('success', translate('تمت العملية بنجاح')) : back()->with('success', translate('تمت العملية بنجاح')) ;
    }
